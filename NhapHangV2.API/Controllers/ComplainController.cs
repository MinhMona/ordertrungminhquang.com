                ...
                if (item != null)
                {
                    ...
                    if (success)
                    {
                        ...
                        if (notiTemplate != null && notificationSetting.Active)
                        {
                            ...
                            await sendNotificationService.SendNotification(notificationSetting, notiTemplate, item.MainOrderId.ToString(), "/order/complain-list", "", null, subject, emailContent); //Thông báo Email
                        }
                        #endregion
